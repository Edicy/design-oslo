    ...
    <div class="form_area">
      <div class="form_fields">
        ...
        <div class="form_field{% if comment_body_error %} form_field_with_errors{% endif %}">
          <label class="form_field_label" for="comment-form-body">{{ "comment" | lc }}{% if comment_body_error %}<span class="form_field_error"> — {{ "comment_body_blank" | lc }}</span>{% endif %}</label>
